...
def main():
    ...
    if not args.no_dashboard:
        html_path = generate_dashboard(stock_rs, industry_rs, sector_rs, leaders, history_df=full_hist, sector_history_df=sec_full_hist, basing_df=basing, launch_pad_df=launch_pad)
        print(f"  → {html_path}")
    else:
